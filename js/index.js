...
sparkle.style.background = "linear-gradient(to left," + color1 + ",rgba(0,0,0,0))";
...
sparkle_.style.background = "linear-gradient(to left," + color2 + ",rgba(0,0,0,0))";
...
sparkle_.style.background = "linear-gradient(to left," + color3 + ",rgba(0,0,0,0))";
firework.appendChild(sparkle_);
}
